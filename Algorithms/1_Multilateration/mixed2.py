...
TECH_PARAMS = {
    'wifi': {'RSSI0dbm': -47.75, 'n': 1.259},
    'ble': {'RSSI0dbm': -45.24, 'n': 1.459},
    'sle': {'RSSI0dbm': -45.85, 'n': 1.469}
}
...
for dataset_name, config in datasets.items():
    ...
    error_df.to_csv(f'pointwise_error_{dataset_name}.csv', index=False)
