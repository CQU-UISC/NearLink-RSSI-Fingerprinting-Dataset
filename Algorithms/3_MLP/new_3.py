...
X_train = df_train[['wifi_rssi1', 'wifi_rssi2', 'wifi_rssi3', 'wifi_rssi4', 'sle_rssi1', 'sle_rssi2', 'sle_rssi3', 'sle_rssi4', 'ble_rssi1', 'ble_rssi2', 'ble_rssi3', 'ble_rssi4']].values
y_train = df_train[['x', 'y']].values
X_test = df_test[['wifi_rssi1', 'wifi_rssi2', 'wifi_rssi3', 'wifi_rssi4', 'sle_rssi1', 'sle_rssi2', 'sle_rssi3', 'sle_rssi4', 'ble_rssi1', 'ble_rssi2', 'ble_rssi3', 'ble_rssi4']].values
