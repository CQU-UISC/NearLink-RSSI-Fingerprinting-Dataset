...
df_train = pd.read_csv('wifi_train_dataset_1_5m.csv')
df_test = pd.read_csv('wifi_test_dataset_1_5m.csv')

# Prepare features (RSSI) and targets (x, y)
X_train = df_train[['rssi1', 'rssi2', 'rssi3', 'rssi4']].values
y_train = df_train[['x', 'y']].values
X_test = df_test[['rssi1', 'rssi2', 'rssi3', 'rssi4']].values
