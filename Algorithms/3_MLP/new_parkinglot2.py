...
# # Prepare features (RSSI) and targets (x, y)
# X_train = df_train[['wifi_rssi1', 'wifi_rssi2', 'wifi_rssi3', 'wifi_rssi4', 'wifi_rssi5', 'wifi_rssi6', 'wifi_rssi7', 'wifi_rssi8',
#                      'sle_rssi1', 'sle_rssi2', 'sle_rssi3', 'sle_rssi4', 'sle_rssi5', 'sle_rssi6', 'sle_rssi7', 'sle_rssi8']].values
# y_train = df_train[['x', 'y']].values
# X_test = df_test[['wifi_rssi1', 'wifi_rssi2', 'wifi_rssi3', 'wifi_rssi4', 'wifi_rssi5', 'wifi_rssi6', 'wifi_rssi7', 'wifi_rssi8',
#                    'sle_rssi1', 'sle_rssi2', 'sle_rssi3', 'sle_rssi4', 'sle_rssi5', 'sle_rssi6', 'sle_rssi7', 'sle_rssi8']].values
# y_test = df_test[['x', 'y']].values
...
# Prepare features (RSSI) and targets (x, y)
X_train = df_train[['ble_rssi1', 'ble_rssi2', 'ble_rssi3', 'ble_rssi4', 'ble_rssi5', 'ble_rssi6', 'ble_rssi7', 'ble_rssi8',
                     'sle_rssi1', 'sle_rssi2', 'sle_rssi3', 'sle_rssi4', 'sle_rssi5', 'sle_rssi6', 'sle_rssi7', 'sle_rssi8']].values
y_train = df_train[['x', 'y']].values
X_test = df_test[['ble_rssi1', 'ble_rssi2', 'ble_rssi3', 'ble_rssi4', 'ble_rssi5', 'ble_rssi6', 'ble_rssi7', 'ble_rssi8',
                   'sle_rssi1', 'sle_rssi2', 'sle_rssi3', 'sle_rssi4', 'sle_rssi5', 'sle_rssi6', 'sle_rssi7', 'sle_rssi8']].values
y_test = df_test[['x', 'y']].values
...
model = Sequential([
    Dense(256, activation='relu', input_shape=(16,)),
    BatchNormalization(),
    Dropout(0.3),
