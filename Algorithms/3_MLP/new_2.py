...
df_train = pd.read_csv('train_ble_sle_dataset_1_5m.csv')
df_test = pd.read_csv('test_ble_sle_dataset_1_5m.csv')

# # Prepare features (RSSI) and targets (x, y)
# X_train = df_train[['wifi_rssi1', 'wifi_rssi2', 'wifi_rssi3', 'wifi_rssi4', 'ble_rssi1', 'ble_rssi2', 'ble_rssi3', 'ble_rssi4']].values
# y_train = df_train[['x', 'y']].values
# X_test = df_test[['wifi_rssi1', 'wifi_rssi2', 'wifi_rssi3', 'wifi_rssi4', 'ble_rssi1', 'ble_rssi2', 'ble_rssi3', 'ble_rssi4']].values
# y_test = df_test[['x', 'y']].values

# # Prepare features (RSSI) and targets (x, y)
# X_train = df_train[['wifi_rssi1', 'wifi_rssi2', 'wifi_rssi3', 'wifi_rssi4', 'sle_rssi1', 'sle_rssi2', 'sle_rssi3', 'sle_rssi4']].values
# y_train = df_train[['x', 'y']].values
# X_test = df_test[['wifi_rssi1', 'wifi_rssi2', 'wifi_rssi3', 'wifi_rssi4', 'sle_rssi1', 'sle_rssi2', 'sle_rssi3', 'sle_rssi4']].values
# y_test = df_test[['x', 'y']].values

# Prepare features (RSSI) and targets (x, y)
X_train = df_train[['ble_rssi1', 'ble_rssi2', 'ble_rssi3', 'ble_rssi4', 'sle_rssi1', 'sle_rssi2', 'sle_rssi3', 'sle_rssi4']].values
y_train = df_train[['x', 'y']].values
X_test = df_test[['ble_rssi1', 'ble_rssi2', 'ble_rssi3', 'ble_rssi4', 'sle_rssi1', 'sle_rssi2', 'sle_rssi3', 'sle_rssi4']].values
y_test = df_test[['x', 'y']].values
